...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css">
  ...
  ${msg2}  ${msg3}</center></h3>
				...
				<form role="form" action="userForm" method="post" >	
				...
				<div class="modal-footer">
					<a href="registration"><button  type="button"  class="btn btn-warning" data-dismiss="modal">Sign Up!</button></a>
					<a href="login"><button  type="button" class="btn btn-danger" data-dismiss="modal">Forget Password?</button></a>
					</div>
				</div>
			</div>
		</form>
