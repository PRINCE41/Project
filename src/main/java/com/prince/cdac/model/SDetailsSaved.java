...
public class SDetailsSaved {
	...
	public String toString() {
		return "SDetailsSaved [uId=" + uId + ", formNo=" + formNo + ", prnNo=" + prnNo + ", name=" + name
				+ ", adm_course=" + adm_course + ", dob=" + dob + ", email=" + email + ", phone=" + phone + ", gender="
				+ gender + ", fName=" + fName + ", fMobile=" + fMobile + ", blood_gp=" + blood_gp + ", mName=" + mName
				+ ", mMobile=" + mMobile + ", cAddress=" + cAddress + ", pAddress=" + pAddress
				+ ", ssc_year_of_passing=" + ssc_year_of_passing + ", ssc_university=" + ssc_university + ", ssc_marks="
				+ ssc_marks + ", hsc_year_of_passing=" + hsc_year_of_passing + ", hsc_university=" + hsc_university
				+ ", hsc_marks=" + hsc_marks + ", dip_branch=" + dip_branch + ", dip_year_of_passing="
				+ dip_year_of_passing + ", dip_university=" + dip_university + ", dip_marks=" + dip_marks
				+ ", deg_name=" + deg_name + ", deg_branch=" + deg_branch + ", deg_year_of_passing="
				+ deg_year_of_passing + ", deg_university=" + deg_university + ", deg_marks=" + deg_marks
				+ ", pgdeg_name=" + pgdeg_name + ", pgdeg_branch=" + pgdeg_branch + ", pgdeg_year_of_passing="
				+ pgdeg_year_of_passing + ", pgdeg_university=" + pgdeg_university + ", pgdeg_marks=" + pgdeg_marks
				+ "]";
	}
